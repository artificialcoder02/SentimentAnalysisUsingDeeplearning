...
FREQ_DIST_FILE = (r'C:\Users\rctuh\Desktop\sentimentAIET\dataset\train-processed-freqdist.pkl')
BI_FREQ_DIST_FILE = (r'C:\Users\rctuh\Desktop\sentimentAIET\dataset\train-processed-freqdist-bi.pkl')
TRAIN_PROCESSED_FILE = (r'C:\Users\rctuh\Desktop\sentimentAIET\dataset\train-processed.csv')
TEST_PROCESSED_FILE = (r'C:\Users\rctuh\Desktop\sentimentAIET\dataset\test-processed.csv')
TRAIN = True
UNIGRAM_SIZE = 15000
...
if __name__ == '__main__':
    ...
    i = 1
    for test_set_X, _ in extract_features(test_tweets, feat_type=FEAT_TYPE, batch_size=batch_size, test_file=False):
    ...
    print('Test set\n  Loss: {:0.3f}\n  Accuracy: {:0.3f}'.format(predictions[0],predictions[1]))
    utils.save_results_to_csv(predictions, '1layerneuralnet.csv')
    print ('\nSaved to 1layerneuraclnet.csv')
